...
*/
    ...
    public void test1(){
        ...
        System.out.println(drops.size());  // Integer veriyor yani listenin sayısını verdi
        for (WebElement w:drops) {
            System.out.println(w.getText());
        }
        int dropDownListesi = drops.size();
        int expectedSayi = 45;
        Assert.assertNotEquals(expectedSayi,dropDownListesi);
    }
    @Test
    public void test2(){
