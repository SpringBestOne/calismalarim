...
tıklayın ve result mesajında isminizin görüntülendiğini doğrulayın.
    ...
    public void test3() throws InterruptedException {
        ...
        Thread.sleep(2000);
        System.out.println("3. Butonun allert mesji = " + driver.switchTo().alert().getText());
        driver.switchTo().alert().sendKeys("Gulsah");
        driver.switchTo().alert().accept();
      //  result mesajında isminizin görüntülendiğini doğrulayın.
  WebElement actualMesaj=driver.findElement(By.xpath("//*[@id='result']"));

        String expected= "Gulsah";
     //   Assert.assertTrue(actualMesaj.contains(expected));
    }
}