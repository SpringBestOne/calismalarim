...
public class C02_FileExistsUpload extends TestBaseBeforeAfter {
    ...
    public void test1() {
        ...
        String dosyaYolu = "C:\\Users\\samsung\\Downloads\\Yeni Metin Belgesi.txt";

        //Dosya yolunu almak için, mause ile dosyanın üzerine gel,
        // şifte bas ve sağ tıkla, dosya kısayolunu kopyala butonunu seç
