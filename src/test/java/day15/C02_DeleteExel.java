...
public class C02_DeleteExel {
    ...
    public void readExelTest1() throws IOException {
        ...
        Cell silinecekHucre = row.getCell(3);  //Satır seçimi yapıldıktan sonra hücre seçimi bu şekilde yapılır


        //- 3. index'deki satirin 3. index'indeki datanin (Cezayir) i silin
        row.removeCell(silinecekHucre);
